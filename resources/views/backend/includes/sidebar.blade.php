<aside class="sidebar-wrapper">
    ...
    <div class="textmenu">
        <div class="brand-logo">
            <img src="{{ asset('/') }}backend-assets/assets/images/brand-logo-2.png" width="140"
                alt="" />
        </div>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            <a href="index2.html" class="list-group-item nav-link dropdown-toggle"
                                data-bs-toggle="dropdown"><i class="bi bi-wallet"></i>Departments</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('departments.create') }}">Add Department</a>
                                <a class="dropdown-item" href="{{ route('departments.index') }}">Manage Department</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="index2.html" class="list-group-item nav-link dropdown-toggle"
                                data-bs-toggle="dropdown"><i class="bi bi-wallet"></i>Doctors</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('doctors.create') }}">Add Doctor</a>
                                <a class="dropdown-item" href="{{ route('doctors.index') }}">Manage Doctor</a>
                            </div>
                        </div>
                    </div>
